...
/*  
    ...
    if(ButtonFont) {
        ...
        SDL_Surface* surfaceMessage = TTF_RenderText_Blended(ButtonFont, FPS_text, White); 
        SDL_Texture* Message = SDL_CreateTextureFromSurface(screenRenderer, surfaceMessage);
        int w,h;
        SDL_QueryTexture(Message, NULL, NULL, &w, &h);
        renderTexture(Message,  0,0);
