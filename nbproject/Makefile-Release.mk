...
${OBJECTDIR}/container.o: container.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/container.o container.cpp
...
${OBJECTDIR}/graphicOperations.o: graphicOperations.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicOperations.o graphicOperations.cpp

${OBJECTDIR}/guiObjectTree.o: guiObjectTree.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/guiObjectTree.o guiObjectTree.cpp
...
${OBJECTDIR}/palette.o: palette.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/palette.o palette.cpp

${OBJECTDIR}/pixelOperations.o: pixelOperations.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pixelOperations.o pixelOperations.cpp

${OBJECTDIR}/scrollbar.o: scrollbar.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scrollbar.o scrollbar.cpp
...
${OBJECTDIR}/themes.o: themes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/themes.o themes.cpp
